...
import { bootstrapFacebookAutoResume } from "../../../../facebook-auto/lib/bot";
...
export async function POST(request: NextRequest) {
  ...
  await bootstrapFacebookAutoResume();
  return NextResponse.json({ ok: true, message: "Facebook Auto resumed" });
}
